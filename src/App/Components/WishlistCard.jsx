      ...
      <div className="p-4 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-gray-400 text-sm">{props.oldprice}</span>
          </div>
            <div className="mt-4">
            <span className= "mt-4 text-sm px-2 py-1 rounded-full font-semibold bg-red-500 text-white"> {props.stock} </span>
            </div>
        </div>
      </div>
      <div className="absolute bottom-4 left-4 right-4 flex gap-2">
        <button className="flex-1 h-10 flex items-center justify-center font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 disabled:opacity-40">
          Move to Cart
        </button>
